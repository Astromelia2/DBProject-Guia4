...
public class VistaBienvenida extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 210, 270, 40));

        txtFondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Fondos/Fondo bienvenida.jpg"))); // NOI18N
        txtFondo.setOpaque(true);
        txtFondo.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(txtFondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(-280, -50, 780, 560));
